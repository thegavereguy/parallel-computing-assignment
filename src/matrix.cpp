...
//   __m256 row0 = _mm256_loadu_ps(&src[(block_row + 0) * n + block_col]);
//   __m256 row1 = _mm256_loadu_ps(&src[(block_row + 1) * n + block_col]);
//   __m256 row2 = _mm256_loadu_ps(&src[(block_row + 2) * n + block_col]);
//   __m256 row3 = _mm256_loadu_ps(&src[(block_row + 3) * n + block_col]);
//   __m256 row4 = _mm256_loadu_ps(&src[(block_row + 4) * n + block_col]);
//   __m256 row5 = _mm256_loadu_ps(&src[(block_row + 5) * n + block_col]);
//   __m256 row6 = _mm256_loadu_ps(&src[(block_row + 6) * n + block_col]);
//   __m256 row7 = _mm256_loadu_ps(&src[(block_row + 7) * n + block_col]);
//   printf("row0: %f %f %f %f %f %f %f %f\n", row0[0], row0[1], row0[2],
//   row0[3],
...
//   printf("col0: %f %f %f %f %f %f %f %f\n", col0[0], col0[1], col0[2],
//   col0[3],
//          col0[4], col0[5], col0[6], col0[7]);
//
//   // Store: salva le colonne trasposte nei blocchi
//   _mm256_storeu_ps(&dst[(block_row + 0) * n + block_col], col0);
//   _mm256_storeu_ps(&dst[(block_row + 1) * n + block_col], col1);
//   _mm256_storeu_ps(&dst[(block_row + 2) * n + block_col], col2);
//   _mm256_storeu_ps(&dst[(block_row + 3) * n + block_col], col3);
//   _mm256_storeu_ps(&dst[(block_row + 4) * n + block_col], col4);
//   _mm256_storeu_ps(&dst[(block_row + 5) * n + block_col], col5);
//   _mm256_storeu_ps(&dst[(block_row + 6) * n + block_col], col6);
//   _mm256_storeu_ps(&dst[(block_row + 7) * n + block_col], col7);
// }
